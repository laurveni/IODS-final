# Laura Venieri 10/12/2017, laura.venieri@helsinki.fi
# Data wrangling for IODS final project on "Human development" and "Gender inequality" datas
...
#structure of human_: 155 obs. of  8 variables
str(human_)
